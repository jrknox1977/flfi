...
class FLFI:
    ...
    # ---> The next section is the default data  for common files and patterns to use to find them:
    ...
    def check_all_files_curl(self,url):
...
for f in lfi.common_files:
    ...
    if answer != "I got nothing":
        lfi.check_all_files_curl(answer)